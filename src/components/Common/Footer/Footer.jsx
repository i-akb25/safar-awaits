    ...
    <footer className="pt-5">
      <Container>
        <Row>
          ...
          <a target="_blank" href="mailto:anuragaryanofficial@gmail.com" className="d-block" >anuragaryanofficial@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:8804XXXXXX" className="d-block" >8804XXXXXX</a>
          </div>
